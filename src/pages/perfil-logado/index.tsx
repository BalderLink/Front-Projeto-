      ...
      <section className="relative mt-2 rounded-xl h-96 w-1/2 bg-white left-1/2 transform -translate-x-1/2">
        ...
        <div className="mt-1 bg-green-400 h-1/2 w-full rounded-xl">
          <div className="flex">
            ...
            <p className="text-gray-600 text-sm ml-2">- 23/10/2021, às 19:32 - João - Avaliação</p>
          </div>
          <div>
            <p className="text-black text-sm ml-4">Não Gosto desta pessoa, todo o problema é que faz ti, fora isso ótima personalidade</p>
          </div>
        ...
        <div className="mt-2 bg-green-400 h-1/2 w-full rounded-xl">
          <div className="flex">
            ...
            <p className="text-gray-600 text-sm ml-2">- 05/12/2022, às 20:16 - Vitor - Avaliação</p>
          </div>
          <div>
            <p className="text-black text-sm ml-4">Gosto muito como pessoa, porém a didática como professor não é das melhores. Mas tem muito conteúdo extra para estudar o que facilita muito a matéria.</p>
          </div>
          <p className="text-black text-sm ml-6">💬 5 Comentários</p>
        </div>
      </section>
