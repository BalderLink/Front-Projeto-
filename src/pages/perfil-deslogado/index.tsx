    ...
    <div className="bg-gray-300 flex flex-col min-h-screen">
      <div className="bg-green-200 h-16 w-full flex justify-between">
        ...
        <header className="bg-green-200 flex justify-between items-center p-4">
          <button className="w-24 h-10 m-4 bg-blue-500 text-white border-2 border-white rounded-xl">
            Fazer Login
          </button>
        </header>
      </div>
      ...
      <section className="relative mt-2 rounded-xl h-96 w-1/2 bg-white left-1/2 transform -translate-x-1/2">
        ...
        <div className="mt-1 bg-green-400 h-1/2 w-full rounded-xl ">
          ...
          <div className="">
            <p className="text-black text-sm ml-4">
              Não Gosto desta pessoa, todo o problema e que faz ti, fora isso
              ótima personalidade
            </p>
          </div>
        ...
        <div className="mt-2 bg-green-400 h-1/2 w-full rounded-xl ">
          ...
          <div className="">
            <p className="text-black text-sm ml-4">
              Gosto muito como pessoa, porém a didatica como professor não e das
              melhores. Mas tem muito conteúdo extra para estudar oque facilita
              em muito a materia.
            </p>
          </div>
          <p className="text-black text-sm ml-6"> 💬 5 Comentários</p>
